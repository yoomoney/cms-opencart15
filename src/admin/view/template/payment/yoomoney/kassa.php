            ...
            <div class="form-group row">
                <div class="col-sm-9 col-sm-offset-3" style="padding-left: 35px;">
                    <label class="checkbox control-label" for="yoomoney_kassa_enable">
                        <input type="checkbox" name="yoomoney_kassa_enable" class="cls_yoomoney_kassamode yoomoney_mode" id="yoomoney_kassa_enable"
        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                <div class="form-group">
                    <label for="yoomoney_kassa_shop_id" class="col-sm-3 control-label"><?php echo $lang->get('kassa_shop_id_label'); ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="yoomoney_kassa_password" class="col-sm-3 control-label"><?php echo $lang->get('kassa_password_label'); ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label for="yoomoney_kassa_payment_mode_kassa" class="control-label radio-inline">
                            <input type="radio" name="yoomoney_kassa_payment_mode" id="yoomoney_kassa_payment_mode_kassa"
                                class="cls_yoomoney_paymode" value="kassa"
                    ...
                    <div class="col-sm-9 col-sm-offset-3 selectPayKassa">
                        <div class="checkbox">
                            <label for="yoomoney_kassa_add_installments_button" class="radio-inline control-label">
                                <input type="checkbox" name="yoomoney_kassa_add_installments_button" id="yoomoney_kassa_add_installments_button"
                    ...
                    <div class="col-sm-9 col-sm-offset-3">
                        <label for="yoomoney_kassa_payment_mode_shop" class="radio-inline control-label">
                            <input type="radio" name="yoomoney_kassa_payment_mode" id="yoomoney_kassa_payment_mode_shop"
                                class="cls_yoomoney_paymode" value="shop"
                                <?php echo ($kassa->getEPL() ? '' : 'checked'); ?> />
                    ...
                    <div class="col-sm-9 col-sm-offset-3 selectPayOpt">
                        ...
                        <?php foreach ($kassa->getPaymentMethods() as $val => $name) : ?>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input name="yoomoney_kassa_payment_options[]" class="cls_yoomoney_paymentOpt" type="checkbox"
                                           value="<?php echo $val; ?>"
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="yoomoney_kassa_enable_hold_mode" id="yoomoney_kassa_enable_hold_mode"
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline" for="yoomoney_kassa_send_receipt_off">
                            <input type="radio" name="yoomoney_kassa_send_receipt" id="yoomoney_kassa_send_receipt_off"
                                   class="cls_yoomoney_54lawmode" value="0"
                        ...
                        <label class="radio-inline" for="yoomoney_kassa_send_receipt_on">
                            <input type="radio" name="yoomoney_kassa_send_receipt" id="yoomoney_kassa_send_receipt_on"
                                   class="cls_yoomoney_54lawmode" value="1"
                        ...
                        <p style="padding-top: 8px;">
                            <div class="checkbox">
                                <label>
                                    ...
                                    <input type="checkbox" name="yoomoney_kassa_second_receipt_enable" id="yoomoney_kassa_second_receipt_enable" <?= $kassa->isSecondReceiptEnable() ? 'checked' : ''; ?> value="1"/>
                        ...
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="border: none">
                                        <select id="yoomoney_kassa_second_receipt_status" name="yoomoney_kassa_second_receipt_status" class="form-control col-xl-4 col-md-4" data-toggle="tooltip" data-placement="left" title="">
                                            <?php foreach ($orderStatusList as $id => $status) : ?>
